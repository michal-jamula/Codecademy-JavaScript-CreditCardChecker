...
// Question 3 - checked and working
//returns true of Card is valid
...
//Question 4
//Checks through nested array and returns nested array of invalid numbers
const findInvalidCards = nArray => {
  let resultArray = [];
  nArray.forEach(array => {
...
//Question 5
//Returns an array of companies which mailed out invalid numbers without duplicates
